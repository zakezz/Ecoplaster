		...
		<table>
			...
			<tr id="facade8" style="display: none;">
				...
				<td>Pignon : non <input type="radio"
					...
					onclick="hide('pignon8');cleart('Hauteur_pignon_8');"/> oui <input type="radio" id="facade_avec_pignon_8"
