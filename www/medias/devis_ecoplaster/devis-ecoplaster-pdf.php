...
// script permettant la mis en transparence de n'importe quel objet http://www.fpdf.org/en/script/script74.php
...
$PDF->AddPage();
 ...
 // Page header
	...
	$PDF->SetAlpha(0.5);
	// Devis provisoire
    $PDF->Image('images/filigrane_devisprovisoire.jpg',40,100,150);

	// On rend l'alpha opaque
	$PDF->SetAlpha(0.75);
